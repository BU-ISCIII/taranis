...
def check_arg (args=None) :
    ...
    allele_calling_parser.add_argument('-c','--coregenedir', required= True,
    ...
    allele_calling_parser.add_argument('-cpus', required= False,
                                    ...
                                    default = 1)
    allele_calling_parser.add_argument('-u', '--updateschema' , required=False,
    ...
    evaluate_schema_parser.add_argument('-i ', '--inputdir',required= True,
                                    help = 'Directory where are the schema files.')
    evaluate_schema_parser.add_argument('-o', '--outputdir', required= True,
                                    help = 'Directory where the result files will be stored.')
    ...
    create_schema_parser.add_argument('-o', '--outputdir', help = 'Directory where the core gene files '
